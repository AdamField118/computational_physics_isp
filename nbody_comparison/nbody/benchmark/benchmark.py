...
sys.path.append('nbody_comparison/nbody/jax')
...
def plot_results(results: List[BenchmarkResult], output_dir: str = 'nbody_comparison/nbody/web/data'):
...
def save_results_json(results: List[BenchmarkResult], output_dir: str = 'nbody_comparison/nbody/web/data'):
